...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoAdjuntoCertificadoListarDto> ListaTiposAdjuntoCertificado { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoAdjuntoCertificadoAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Típos de adjunto de certificado]", "error");
                return;
            }

			ListaTiposAdjuntoCertificado = await ITipoAdjuntoCertificado.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-adjunto-certificado/{id}");

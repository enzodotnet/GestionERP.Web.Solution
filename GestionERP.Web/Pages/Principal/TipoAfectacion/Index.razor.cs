...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoAfectacionListarDto> ListaTiposAfectacion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaTiposAfectacion = await ITipoAfectacion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-afectacion/{id}");

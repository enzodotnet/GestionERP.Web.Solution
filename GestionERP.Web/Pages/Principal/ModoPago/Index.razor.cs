...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<ModoPagoListarDto> ListaModosPago { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaModosPago = await IModoPago.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"modos-pago/{id}");

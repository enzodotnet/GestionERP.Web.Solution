...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<MedioPagoListarDto> ListaMediosPago { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(MedioPagoAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Medio de pago]", "error");
                return;
            }

			ListaMediosPago = await IMedioPago.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"medios-pago/{id}");

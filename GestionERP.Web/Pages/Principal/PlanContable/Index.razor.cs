...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<PlanContableListarDto> ListaPlanContable { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
			...
			ListaPlanContable = await IPlanContable.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"plan-contable/{id}");

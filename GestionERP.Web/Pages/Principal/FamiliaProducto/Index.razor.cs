...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<FamiliaProductoListarDto> ListaFamiliasProducto { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        try
        {
			...
			ListaFamiliasProducto = await IFamiliaProducto.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"familias-producto/{id}");

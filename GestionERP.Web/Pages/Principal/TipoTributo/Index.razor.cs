...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoTributoListarDto> ListaTiposTributo { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
			...
			ListaTiposTributo = await ITipoTributo.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-tributo/{id}");

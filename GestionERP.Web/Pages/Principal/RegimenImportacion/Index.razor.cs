...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<RegimenImportacionListarDto> ListaRegimenesImportacion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaRegimenesImportacion = await IRegimenImportacion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"regimenes-importacion/{id}");

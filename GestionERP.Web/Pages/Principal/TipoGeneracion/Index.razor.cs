...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoGeneracionListarDto> ListaTiposGeneracion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoGeneracionAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Típos de Generación]", "error");
                return;
            }

			ListaTiposGeneracion = await ITipoGeneracion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-generacion/{id}");

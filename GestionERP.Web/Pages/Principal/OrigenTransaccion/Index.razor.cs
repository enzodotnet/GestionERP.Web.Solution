...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<OrigenTransaccionListarDto> ListaOrigenesTransaccion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(OrigenTransaccionAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Origenes de Transacciones]", "error");
                return;
            }

			ListaOrigenesTransaccion = await IOrigenTransaccion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"origenes-transaccion/{id}");

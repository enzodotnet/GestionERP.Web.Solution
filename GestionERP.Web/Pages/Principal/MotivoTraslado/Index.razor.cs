...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<MotivoTrasladoListarDto> ListaMotivosTraslado { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaMotivosTraslado = await IMotivoTraslado.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"motivos-traslado/{id}");

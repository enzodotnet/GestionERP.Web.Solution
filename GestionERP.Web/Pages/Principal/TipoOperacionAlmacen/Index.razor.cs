...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoOperacionAlmacenListarDto> ListaTiposOperacionAlmacen { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
			...
			ListaTiposOperacionAlmacen = await ITipoOperacionAlmacen.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-operacion-almacen/{id}");

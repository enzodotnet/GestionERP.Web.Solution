...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoExistenciaListarDto> ListaTiposExistencia { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaTiposExistencia = await ITipoExistencia.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-existencia/{id}");

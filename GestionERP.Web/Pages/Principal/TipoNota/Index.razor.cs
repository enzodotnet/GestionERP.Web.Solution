...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoNotaListarDto> ListaTiposNota { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoNotaAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Tipos de Nota]", "error");
                return;
            }

			ListaTiposNota = await ITipoNota.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-nota/{id}");

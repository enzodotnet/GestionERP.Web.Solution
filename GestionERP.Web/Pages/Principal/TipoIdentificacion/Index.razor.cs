...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoIdentificacionListarDto> ListaTiposIdentificacion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoIdentificacionAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Tipo de identificación]", "error");
                return;
            }

			ListaTiposIdentificacion = await ITipoIdentificacion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-identificacion/{id}");

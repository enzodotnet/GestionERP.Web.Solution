...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoComprobanteListarDto> ListaTiposComprobante { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
			...
			ListaTiposComprobante = await ITipoComprobante.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-comprobante/{id}");

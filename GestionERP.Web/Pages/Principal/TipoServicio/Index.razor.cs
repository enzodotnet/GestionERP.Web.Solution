...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoServicioListarDto> ListaTiposServicio { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoServicioAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Típos de servicios]", "error");
                return;
            }

			ListaTiposServicio = await ITipoServicio.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-servicio/{id}");

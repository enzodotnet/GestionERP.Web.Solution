...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoMovimientoListarDto> ListaTiposMovimiento { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
			...
			ListaTiposMovimiento = await ITipoMovimiento.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-movimiento/{id}");

...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoFinancieraListarDto> ListaTiposFinanciera { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaTiposFinanciera = await ITipoFinanciera.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-financiera/{id}");

...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<EjercicioListarDto> ListaEjercicios { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaEjercicios = await IEjercicio.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"ejercicios/{id}");

...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<ProductoEstadoListarDto> ListaProductoEstados { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaProductoEstados = await IProductoEstado.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"producto-estados/{id}");

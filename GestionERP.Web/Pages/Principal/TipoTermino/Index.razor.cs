...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoTerminoListarDto> ListaTiposTermino { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoTerminoAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Típos de términos]", "error");
                return;
            }

			ListaTiposTermino = await ITipoTermino.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-termino/{id}");

...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<TipoTransaccionListarDto> ListaTiposTransaccion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        { 
            ...
            if (!await IPermiso.ConsultaEsAsignadoPorSesion(TipoTransaccionAcceso.VerRegistros))
            {
                ...
                Notify.Show("No tiene permiso para ver registros del servicio principal de [Típos de Transacciones]", "error");
                return;
            }

			ListaTiposTransaccion = await ITipoTransaccion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"tipos-transaccion/{id}");

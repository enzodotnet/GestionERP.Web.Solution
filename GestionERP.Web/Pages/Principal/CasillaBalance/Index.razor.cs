...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<CasillaBalanceListarDto> ListaCasillaBalances { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaCasillaBalances = await ICasillaBalance.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"casillas-balance/{id}");

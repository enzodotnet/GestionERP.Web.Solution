...
public partial class Index : IDisposable
{
    ...
    private IEnumerable<SituacionImportacionListarDto> ListaSituacionesImportacion { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {  
			...
			ListaSituacionesImportacion = await ISituacionImportacion.Listar();
			IsInitGrid = true;
		}
        catch (Exception ex)
        {
    ...
    private void IrVer(Guid id) => INavigation.NavigateTo($"situaciones-importacion/{id}");

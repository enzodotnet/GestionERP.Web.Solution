...
public class EmpresaAtributoEditarDto
{
...
public class EmpresaAtributoEditarValidator : AbstractValidator<EmpresaAtributoEditarDto>
{
    public EmpresaAtributoEditarValidator()
    {
        RuleFor(p => p.DireccionFiscal)
            .Cascade(CascadeMode.Stop)
            .NotEmpty().WithMessage("El campo {PropertyName} es requerido en el editar atributo") 
            .MaximumLength(200).WithMessage("El campo {PropertyName} debe tener como máximo 200 caracteres en el editar atributo");

        RuleFor(p => p.DireccionDeposito)
            .MaximumLength(200).WithMessage("El campo {PropertyName} debe tener como máximo 200 caracteres en el editar atributo");

        RuleFor(p => p.TelefonoCorporativo)
            .MaximumLength(20).WithMessage("El campo {PropertyName} debe tener como máximo 20 caracteres en el editar atributo");
        
        RuleFor(p => p.TelefonoVenta)
            .MaximumLength(20).WithMessage("El campo {PropertyName} debe tener como máximo 20 caracteres en el editar atributo");
        
        RuleFor(p => p.EmailCorporativo)
            .MaximumLength(50).WithMessage("El campo {PropertyName} debe tener como máximo 50 caracteres en el editar atributo");
        ...
        RuleFor(p => p.PaginaWeb)
            .MaximumLength(30).WithMessage("El campo {PropertyName} debe tener como máximo 30 caracteres en el editar atributo");

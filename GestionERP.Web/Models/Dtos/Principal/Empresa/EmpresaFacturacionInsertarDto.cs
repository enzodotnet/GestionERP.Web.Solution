...
public class EmpresaFacturacionInsertarDto
{  
...
public class EmpresaFacturacionInsertarValidator : AbstractValidator<EmpresaFacturacionInsertarDto>
{
    public EmpresaFacturacionInsertarValidator()
    { 
        RuleFor(p => p.UbicacionCertificado)
            .GreaterThanOrEqualTo(0).WithMessage("El campo {PropertyName} debe ser mayor o igual a 0 (cero) en el insertar facturacion");

        RuleFor(p => p.NumeroSerieCertificado)
            .MaximumLength(100).WithMessage("El campo {PropertyName} debe tener máximo 100 caracteres en el insertar facturacion");
        ...
        RuleFor(p => p.NumeroResolucion) 
            .MaximumLength(50).WithMessage("El campo {PropertyName} debe tener máximo 50 caracteres en el insertar facturacion");
        
        RuleFor(p => p.HostSMTP)  
            .MaximumLength(20).WithMessage("El campo {PropertyName} debe tener máximo 20 caracteres en el insertar facturacion");
        
        RuleFor(p => p.PuertoSMTP)  
            .MaximumLength(4).WithMessage("El campo {PropertyName} debe tener máximo 4 caracteres en el insertar facturacion");
        ...
        RuleFor(p => p.ColorPrincipalPDF)
            .MaximumLength(7).WithMessage("El campo {PropertyName} debe tener máximo 7 caracteres en el insertar facturacion");

...
public class OperacionLogisticaEditarDto
{  
...
public class OperacionLogisticaEditarValidator : AbstractValidator<OperacionLogisticaEditarDto>
{
    public OperacionLogisticaEditarValidator()
    { 
        RuleFor(p => p.Nombre)

...
public class ContratoCuotaEditarDto
{ 
...
public class ContratoCuotaEditarValidator : AbstractValidator<ContratoCuotaEditarDto>
{
    public ContratoCuotaEditarValidator()
    { 

...
public class VersionPlanMaterialEditarDto
{
...
public class VersionPlanMaterialEditarValidator : AbstractValidator<VersionPlanMaterialEditarDto>
{
    public VersionPlanMaterialEditarValidator()
    {

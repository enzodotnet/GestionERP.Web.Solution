...
public class VersionPlanFuncionEditarDto
{  
...
public class VersionPlanFuncionEditarValidator : AbstractValidator<VersionPlanFuncionEditarDto>
{
    public VersionPlanFuncionEditarValidator()
    { 

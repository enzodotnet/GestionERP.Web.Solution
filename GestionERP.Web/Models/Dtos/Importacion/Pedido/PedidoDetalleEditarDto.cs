...
public class PedidoDetalleEditarDto
{ 
...
public class PedidoDetalleEditarValidator : AbstractValidator<PedidoDetalleEditarDto>
{
    public decimal? UnidadConversion { get; set; }
    public string FlagTipoMoneda { get; set; }

    public PedidoDetalleEditarValidator()
    { 

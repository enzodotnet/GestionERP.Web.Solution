...
public interface IProduccionSolicitud
{
    Task<IEnumerable<SolicitudListarDto>> Listar(string codigoEmpresa, string codigoEjercicio, string codigoPeriodo = null, string flagTipoRegistro = null);
